...
impl<Client: SatoriClient, Parser: SatoriParser, T: TokenStorage>
    SimpleSatori<Client, Parser, T>
{
    ...
    for SimpleSatori<Client, Parser, T>
{
    ...
    fn problems(&self, contest: &str, force: bool) -> SatoriResult<Vec<Problem>> {
        ...
        let contest_id = match candidates.len() {
            ...
            _ => return Err(SatoriError::AmbiguousContest(
                AmbiguousNameError { name: contest.to_string(),
